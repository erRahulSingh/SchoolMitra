...
SchoolMitra is an enterprise-grade, multi-tenant Software-as-a-Service (SaaS) platform designed for educational institutions. The platform operates on a single-database multi-tenancy model using indexed `schoolId` scoping.
