...
export default function AboutPage() {
  ...
  return (
    <div style={{ background: "var(--bg-page)", minHeight: "100vh", color: "var(--text-main)", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <section style={{
        paddingTop: 115, paddingBottom: 40, paddingLeft: "5%", paddingRight: "5%",
        background: "var(--bg-page)", position: "relative"
      }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1.05fr 0.95fr", gap: "3.5rem", alignItems: "flex-start" }}>
